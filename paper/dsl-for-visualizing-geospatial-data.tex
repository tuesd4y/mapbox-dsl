...
Furhtermore, we would like to thank triply GmbH for providing a pre-calculated dataset of Vienna's population grid sourced from the GEOSTAT 2011 grid dataset published by the European Commission.
